...
import { menuItems } from "@/navigation/sidebar";
...
export default function Sidebar({
  ...
  return (
    <div
      ...
      } fixed inset-y-0 left-0 z-50 w-80 bg-white/10 backdrop-blur-2xl border-r border-white/20 transform transition-all duration-500 ease-out 
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6">
        <div className="relative overflow-hidden bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-3xl p-6 border border-white/20">
          ...
          <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-white/80 to-transparent rounded-full translate-x-10 -translate-y-10" />
